...
import com.lw.clouddelivery.ui.exam.VoteSubmitViewPager;
...
public class TrainVoteSubmitActivity extends BaseActivity {
...
//		getTitleBar().initTitleText("培训资料");
	...
	private void init() {
		...
		pagerAdapter = new VoteSubmitAdapter(TrainVoteSubmitActivity.this, viewItems, dataItems);
