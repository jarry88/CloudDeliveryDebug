...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        Log.i("slidingUpPanelLayout", "onInterceptTouchEvent");
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
            	Log.i("slidingUpPanelLayout", "down");
            ...
            case MotionEvent.ACTION_MOVE: {
            	Log.i("slidingUpPanelLayout", "move");
...
//            	Log.i("slidingUpPanelLayout", "up");
//            	Log.i("slidingUpPanelLayout", "up___isin---"+isDragViewHit((int)x, (int)y));
//            	if (!isDragViewHit((int)x, (int)y)) {
//            		collapsePanel();
//				}
//            	break;
...
//	}
    ...
    private boolean isDragViewHit(int x, int y) {
        if (isPanelExpanded()) {
            return true; //true，展开后任意拖动拦截，false不拦截
        } else {
            // original implementation - only allow dragging on mDragView
            View v = mDragView != null ? mDragView : mSlideableView;
            if (v == null)
